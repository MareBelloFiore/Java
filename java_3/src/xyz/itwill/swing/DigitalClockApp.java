...
//=> 새로운 스레드를 생성하여 날짜와 시간을 초마다 제공받아 컴포넌트 변경
public class DigitalClockApp extends JFrame {
	private static final long serialVersionUID = 1L;

	//날짜와 시간을 출력하기 위한 컴포넌트를 저장하기 위한 필드
	JLabel clockLabel;
	...
	public DigitalClockApp(String title) {
		...
		*/
		...
		//스레드 객체로 새로운 스레드를 생성해 run() 메소드를 호출하여 실행
	...
	//시스템의 현재 날짜와 시간을 1초마다 제공받아 JLabel 컴포넌트를 변경하는 기능을 
	//제공하는 스레드 클래스
	public class ClockThread extends Thread {
		...
		public void run() {
			...
			while(true) {
				...
				//JLabel.setText(String text) : JLabel 컴포넌트의 문자열을 변경하는 메소
